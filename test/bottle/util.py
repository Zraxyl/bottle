...
# ALPM
PM_ROOT     = "/"
PM_DBPATH   = "var/lib/bottle"
PM_SYNCDBPATH = "var/lib/bottle/sync"
PM_LOCK     = "var/lib/bottle/db.lck"
PM_CACHEDIR = "var/cache/bottle/pkg"
PM_EXT_PKG  = ".pkg.tar.gz"
PM_HOOKDIR  = "etc/bottle.d/hooks"

# Bottle
PACCONF     = "etc/bottle.conf"
