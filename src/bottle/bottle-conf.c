/*
 *  bottle-conf.c - parse bottle configuration files
 *
...
const char *myname = "bottle-conf", *myver = "1.0.0";
...
static void usage(int ret)
{
	...
	fputs(_("bottle-conf - query bottle's configuration file\n"), stream);
	fputs(_("usage:  bottle-conf [options] [<directive>...]\n"), stream);
	fputs(_("        bottle-conf (--repo-list|--help|--version)\n"), stream);
	fputs(_("options:\n"), stream);
