...
Name
----
bottle-conf - query bottle's configuration file


Synopsis
--------
'bottle-conf' [options] [<directive> ...]

'bottle-conf' (--repo-list|--help|--version)


Description
-----------
'bottle-conf' is a utility for parsing the 'bottle' configuration file
...
same configuration values which 'bottle' itself would use.

'bottle-conf' will output the fully-resolved contents of the
