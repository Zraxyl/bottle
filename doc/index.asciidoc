...
(library for Package Management) and the familiar bottle front-end.
...
Mailing List
~~~~~~~~~~~~
There is a mailing list devoted to bottle development, hosted by Zraxyl.
...
hosted by Zraxyl, although some of the developers have their own trees (ask
