...
Introduction
------------
bottle is a utility which manages software packages in Linux. It uses simple
...
bottle does not strive to "do everything." It will add, remove and upgrade
...
History
~~~~~~~
Version 2.0 of bottle introduced the ability to sync packages (the '\--sync'
...
Version 3.0 was the switch to a two-part bottle -- a back-end named libalpm
(library for Evolinx Package Management) and the familiar bottle front-end.
...
makepkg/repo-add/bottle toolchain via GnuPG and GPGME.
...
configuration files dealing with bottle.
...
* linkman:bottle[8]
* linkman:bottle-key[8]
* linkman:bottle-conf[8]
...
Changelog
~~~~~~~~~
For a good idea of what is going on in bottle development, take a look at the
link:https://gitlab.archlinux.org/bottle/bottle[Git summary page] for the
project.

See the most recent
link:https://gitlab.archlinux.org/bottle/bottle/-/blob/master/NEWS[NEWS]
...
link:https://gitlab.archlinux.org/bottle/bottle/-/releases[].
Source code for historical releases is available at
link:https://sources.archlinux.org/other/bottle/[]. To install, download the newest
...
Mailing List
~~~~~~~~~~~~
There is a mailing list devoted to bottle development, hosted by Evolinx.
link:https://lists.archlinux.org/listinfo/bottle-dev/[Subscribe] or
link:https://lists.archlinux.org/pipermail/bottle-dev/[view the archives].

Source Code
~~~~~~~~~~~
Development of bottle is currently done in Git. The central repository is
hosted by Evolinx, although some of the developers have their own trees (ask
...
which will fetch the full development history into a directory named bottle.
You can browse the source as well using
link:https://gitlab.archlinux.org/bottle/bottle/[gitlab].

If you are interested in hacking on bottle, it is highly recommended you join
...
tracker at link:https://gitlab.archlinux.org/bottle/bottle/-/issues[] with
specific information such as your command-line, the nature of the bug, and even
the package database if it helps.

Copyright
---------
bottle is Copyright (C) 2006-2024 Pacman Development Team
